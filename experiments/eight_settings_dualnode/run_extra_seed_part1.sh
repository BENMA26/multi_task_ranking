#!/bin/bash
#SBATCH --job-name=mtl8_extra_p1
#SBATCH --output=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/eight_settings_dualnode/slurm/extra_p1_%j.out
#SBATCH --error=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/eight_settings_dualnode/slurm/extra_p1_%j.err
#SBATCH --ntasks=1
...
RUN_ID=${RUN_ID:-extra_seed_p1_$(date +%Y%m%d_%H%M%S)}
...
run_case() {
    ...
    for raw_seed in "${SEED_LIST[@]}"; do
        ...
        echo "=========================================="
        echo "[EXTRA-P1] setting=${setting} seed=${seed}"
        echo "=========================================="
...
echo "[DONE] extra seed part1 finished. ok=${ok_count} fail=${fail_count}"

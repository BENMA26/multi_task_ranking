#!/bin/bash
#SBATCH --job-name=tenrec_clk_like_collect
#SBATCH --output=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/tenrec/logs/tenrec_clk_like_collect_%j.out
#SBATCH --error=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/tenrec/logs/tenrec_clk_like_collect_%j.err
#SBATCH --ntasks=1
...
# 1) MMOE + ESMM baseline
run_exp "tenrec_mmoe_esmm_click_like_collect_baseline" "
    --gradient_clip_val 0.0
"

# 2) MMOE + ESMM + asymmetric projection
run_exp "tenrec_mmoe_esmm_click_like_collect_asymproj" "
    --use_asym_proj
...
echo "All click+like+collect experiments finished."

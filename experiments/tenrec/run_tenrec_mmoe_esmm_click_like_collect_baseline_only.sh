#!/bin/bash
#SBATCH --job-name=tenrec_clk_like_base
#SBATCH --output=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/tenrec/logs/tenrec_clk_like_base_%j.out
#SBATCH --error=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/tenrec/logs/tenrec_clk_like_base_%j.err
#SBATCH --ntasks=1
...
echo "=========================================="
echo "Experiment: tenrec_mmoe_esmm_click_like_collect_baseline"
echo "=========================================="
...
python -u "${TRAIN_PY}" \
    ...
    --exp_dir "${OUTPUT_ROOT}/tenrec_mmoe_esmm_click_like_collect_baseline"

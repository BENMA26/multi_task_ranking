#!/bin/bash
#SBATCH --job-name=tenrec_mmoe_cmp
#SBATCH --output=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/tenrec/logs/tenrec_mmoe_cmp_%j.out
#SBATCH --error=/work/home/maben/project/rec_sys/projects/multi_task_ranking/experiments/tenrec/logs/tenrec_mmoe_cmp_%j.err
#SBATCH --ntasks=1
...
OUTPUT_ROOT=${PROJECT_ROOT}/experiments/tenrec/outputs
mkdir -p "${OUTPUT_ROOT}"
...
# 1) ESMM + MMOE baseline
run_exp "tenrec_esmm_mmoe_baseline" "
    --gradient_clip_val 0.0
"

# 2) ESMM + MMOE + asymmetric projection
run_exp "tenrec_esmm_mmoe_asymproj" "
    --use_asym_proj
...
echo "Tenrec compare experiments finished."
